...
<%
	...
	<form action ="college_principle_login_action.jsp" method="post">

<label class ="name">
		User Name: <input  class="ip" type="text" name="principle_username"> <br><br>
		Password: <input  class="ip" type="password" name="principle_password">  <br><br>
</label>
