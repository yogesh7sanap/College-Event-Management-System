...
<form style="text-align: center;"action="user_event_regi_by_date_join.jsp" method="post">
   ...
   <form style="text-align: center;"action="user_event_regi_by_name_join.jsp" method="post">
...
<br>
	...
	try{
		...
		ResultSet rs=st.executeQuery("select * from event_table");
