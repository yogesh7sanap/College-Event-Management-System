...
try{
	...
	ResultSet rs=st.executeQuery("select e_id,event_name,event_desc,event_date,event_time,event_location,event_coordinator_name,event_coordinator_mob_no from event_table e natural join user_event_relationship_table  r where u_id='"+uid+"' and event_name like '"+event_n+"%'" );
